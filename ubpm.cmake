...
function(ubpm_gather_prefixes OUT)
  file(GLOB prefixes LIST_DIRECTORIES NO "${UBPM_PATH}/prefix/*")
  set(result "")
...
function(ubpm_dependency NAME)
  ...
  set(install_dir "${UBPM_PATH}/install/${NAME}")
